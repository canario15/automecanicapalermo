...
before_action :set_car_brand, only: [:show, :edit, :update, :destroy]
  ...
  def create
    ...
    respond_to do |format|
      if @car_brand.save
        format.html { redirect_to @car_brand, notice: 'Marca de Vehiculo creada con éxito.' }
  ...
  def update
    respond_to do |format|
      if @car_brand.update(car_brand_params)
        format.html { redirect_to @car_brand, notice: 'La marca de vehículo se ha actualizada correctamente.' }
  ...
  def destroy
    @car_brand.destroy
    respond_to do |format|
      format.html { redirect_to car_brands_url, notice: 'La marca de vehículo se ha dado de baja correctamente' }
  ...
  private
    ...
    # Never trust parameters from the scar_brandy internet, only allow the white list through.
